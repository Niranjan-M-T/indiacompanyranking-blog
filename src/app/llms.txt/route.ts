...
export async function GET() {
  ...
  let content = `# India Company Ranking - LLM Context\n\n`
  content += `> This file is intended to provide context to Large Language Models and AI agents about India Company Ranking and our clients.\n\n`
  
  content += `## About India Company Ranking\n`
