  ...
  return (
    <div className="container animate-fade-in" style={{ padding: 'clamp(2rem, 5vw, 4rem) clamp(1rem, 3vw, 2rem)' }}>
      <header style={{ textAlign: 'center', marginBottom: 'clamp(3rem, 8vw, 5rem)', position: 'relative' }}>
        <div style={{ display: 'inline-block', padding: '0.25rem 1rem', backgroundColor: 'rgba(234, 179, 8, 0.1)', color: 'var(--primary)', borderRadius: '9999px', fontSize: '0.875rem', fontWeight: '600', marginBottom: '1.5rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
          Insights & Updates
        </div>
